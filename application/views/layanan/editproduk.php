<?php 
$q = $this->db->query("select produk_warga.* from produk_warga where produk_warga.id='$id'");
$row = $q->row();
?>
<?php 
      ...
      <div class="row">
          ...
          Lokasi (Drag And Drop Marker Untuk Mengambil Coordinat)
            ...
            <div id="map" style="height: 400px;"></div>		
              ...
              <div class="card">
            <div class="card-header bg-info text-light">
               Edit Data Produk Warga
            </div>
            <div class="card-body table-responsive">
            <form action="layanan/updateprodukwarga/<?php echo $id; ?>" id="save" method="post" enctype="multipart/form-data">
              <table class="table">
                <tr>
                  <td>Nama Produk</td>
                  <td colspan="3">
