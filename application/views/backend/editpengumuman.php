        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="card-header text-light bg-info">
              Form Pengumuman <?php echo $row->judul ?>
            </div>
            <div class="card-body table-responsive">
            <form action="main/updatepengumuman/<?php echo $id; ?>" id="save" method="post" enctype="multipart/form-data">
              <table class="table">
                <tr>
                  <td>Judul Pengumuman</td>
                  <td colspan="3">
                    <input type="text" placeholder="Judul Pengumuman" value="<?php echo $row->judul ?>" class="form-control" name="judul">
                  </td>
                </tr>
                <tr>
                  <td>Tanggal Pengumuman</td>
                  <td colspan="3">
                    <input type="text" placeholder="Tanggal Pengumuman" class="form-control tgl" value="<?php echo $row->date ?>" autocomplete="off" name="date">
                  </td>
                </tr>
                <tr>
                            <td>Foto / Gambar</td>
                ...
                <tr>
                  <td>Deskripsi</td>
                  <td colspan="3">
                      <textarea name="desk" id="" class="summernote" cols="30" rows="10"><?php echo $row->ket ?></textarea>
                  </td>
                </tr>
