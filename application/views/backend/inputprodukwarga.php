...
<div class="main-content">
        <section class="section">
          ...
          Lokasi (Drag And Drop Marker Untuk Mengambil Coordinat)
            ...
            <div class="card-body table-responsive">
            <form action="main/saveprodukwarga" id="save" method="post" enctype="multipart/form-data">
              <table class="table">
                <tr>
                  <td>Nama Produk</td>
                  <td colspan="3">
                ...
                <tr>
                  <td>Pemlik </td>
                  <td colspan="3">
                    <input type="text" placeholder="Pemilik produkk.." class="form-control" name="pemilik">
                  </td>
                </tr>
                <tr>
                  <td>
