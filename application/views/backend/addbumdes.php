      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header text-light bg-info">
            Form Produk BUMDES (BADAN USAHA MILIK DESA)
          </div>
            ...
            <form action="main/savebumdes" id="save" method="post" enctype="multipart/form-data">
              <table class="table">
                ...
                <tr>
                  ...
                  <td colspan="3">
                    <input type="text" placeholder="Kategori Produk" class="form-control" autocomplete="off" name="kat">
                  </td>
                </tr>
                <tr>
                  <td>Harga Produk</td>
                  <td colspan="3">
                    <input type="text" placeholder="Harga Produk" class="form-control uang" autocomplete="off" name="harga">
                  </td>
                </tr>
                <tr>
                  <td>No. Handphone BUMDES</td>
                  <td colspan="3">
                    <input type="number" placeholder="No. Handphone BUMDES" class="form-control" autocomplete="off" name="telp">
                  </td>
                </tr>
                <tr>
                  <td>Foto / Gambar</td>
