          ...
          <div class="section-body">
            ...
            <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="main/saveapb" id="save" method="post">
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tahun</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control tahun" autocomplete="off" placeholder="Tahun " name="tahun">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" autocomplete="off" class="form-control" name="rincian" placeholder="Rincian">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nilai Anggaran</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" autocomplete="off"  class="form-control uang" name="anggaran" placeholder="Nilai Anggaran">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nilai Realisasi</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="text" autocomplete="off"  class="form-control uang" name="nilai" placeholder="Nilai Realisasi">
                      </div>
                    </div>
                    <div class="form-group row mb-4">
