...
<div class="main-content">
        <section class="section">
          ...
          Lokasi (Drag And Drop Marker Untuk Mengambil Coordinat)
            ...
            <div class="card-body table-responsive">
            <form action="main/updateevent/<?php echo $id; ?>" id="save" method="post" enctype="multipart/form-data">
              <table class="table">
                <tr>
                  <td>Judul Event</td>
                  <td colspan="3">
                    <input type="text" placeholder="Judul Event" value="<?php echo $row->judul ?>" class="form-control" name="judul">
                  </td>
                </tr>
                <tr>
                  <td>Tanggal Mulai</td>
                  <td>
                    <input type="text" class="form-control waktu" value="<?php echo $row->mulai ?>" name="mulai">
                  </td>
                  <td>Tanggal Selesai</td>
                  <td>
                    <input type="text" class="form-control waktu" value="<?php echo $row->selesai ?>" name="selesai">
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                  <input name="lat" id="Latitude" type="text" value="<?php echo $row->lat ?>" class="form-control" placeholder="Latitude" required >
                  </td>
                  <td>
                    Longitude
                  </td>
                  <td>
                  <input name="lng" id="Longitude" type="text" value="<?php echo $row->lng ?>" class="form-control" placeholder="Longitude" required>
                  </td>
                </tr>
                ...
                <tr>
                  <td>Lokasi Event</td>
                  <td colspan="3">
                  <textarea class="summernote" name="lokasi"><?php echo $row->lokasi ?></textarea>
                  </td>
                </tr>
                </tr>
      ...
      $("#save").on("submit",function(e){
        ...
        $.ajax({
            ...
            success: function (response) {
                Swal.fire({
                    title: "Informasi",
                    text: "Data akomodasi berhasil disimpan!",
                    icon: "success",
