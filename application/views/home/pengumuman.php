    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Pengumuman <?php echo $setting->web ?></h2>
          <ol>
            <li><a href="home/index">Home</a></li>
            <li>Pengumuman <?php echo $setting->web ?></li>
          </ol>
        </div>
      </div>
...
?>
            <article class="entry">
              ...
              <h2 class="entry-title">
                <a href="home/pengumumanpage/<?php echo $row->slug ?>"><?php echo $row->judul ?></a>
              </h2>
              ...
              <p>
                    <?php echo substr($row->ket,0,160) ?>....        
                </p>
                <div class="read-more">
                  <a href="home/pengumumanpage/<?php echo $row->slug ?>">Read More</a>
                </div>
              </div>
