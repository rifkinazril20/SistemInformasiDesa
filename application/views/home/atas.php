  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a href="home/index" class="<?php if ($this->uri->segment(2) == 'index') echo 'active' ?>">Beranda</a></li>
          ...
          <li><a href="home/galeri" class="<?php if ($this->uri->segment(2) == 'galeri') echo 'active' ?>">Galeri</a></li>
          ...
          <li><a href="home/berita" class="<?php if ($this->uri->segment(2) == 'berita') echo 'active' ?>">Berita / Artikel</a></li>
          ...
          <li><a href="welcome" target="_blank">Login </a></li>
